...
function HomeParagraph() {
  return (
    <p className="home-page-style">
      ...
      security vulnerabilities in hardware and software implementations. My
      research revolves around the meticulous security analysis within a wide
      ...
      implementation vulnerabilities. I possess a profound knowledge of hardware
      design. Leveraging this expertise, I have successfully and securely
      accelerated diverse applications on ASIC/FPGA. Therefore, my Ph.D.
      dissertation focuses on lattice-based crypto-systems for edge-device
      applications, addressing implementation efficiency, flexibility, and
      security concerns.
    </p>
  );
}
