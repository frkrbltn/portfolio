...
import resumePDF from "./FKarabulut_Resume.pdf";
  ...
  return (
    <Container className="resume-custom-style" fluid style={{ marginTop: "30px" }}>
      <Row className="note-row" style={{ margin: "20px auto 0px", fontSize: "20px" }}>
        <a href={resumePDF} target="_blank" rel="noreferrer noopener" download="FKarabulut_Resume.pdf" style={{ color: "inherit", textDecoration: "none" }}>
      ...
      <Row style={{ display:"flex", alignItems: "center", flexDirection:"column"}}>
        <Col xs={12} md={12} lg={10} >
          ...
          <p>
            <h3>Associate Software Engineer, Relias</h3>
            <span className="date">November/2024 - Present</span><br />
            Full-stack engineering on enterprise healthcare and compliance training software. Backend in C# and .NET (ASP.NET Core, EF Core, SQL Server, CosmosDB, CQRS/outbox patterns). Frontend in Angular and TypeScript with RxJS. Azure DevOps pipelines, Bicep for cloud provisioning, and multi-region production deployments using GitOps with Flux and Kustomize on AKS.
          </p>
          <p>
          ...
          <p>
            <h3>Software Engineer, PQSecure Technologies</h3>
